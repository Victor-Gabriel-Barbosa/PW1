class Navbar {
  ...
  getAdminPanel() {
    return `
            ...
            <div id="admin-menu-items" style="z-index: 3;" class="hidden absolute mt-2 w-48 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                <div class="py-1" style="background: var(--background)" role="menu">
                    <a href="./usuarios.html" class="block px-4 py-2 text-sm hover:bg-purple-600" role="menuitem">Usuários</a>
                    <a href="#" class="block px-4 py-2 text-sm hover:bg-purple-600" role="menuitem">Categorias</a>
                    <a href="./add-anime.html" class="block px-4 py-2 text-sm hover:bg-purple-600" role="menuitem">Adicionar anime</a>
                    <a href="./edit-anime.html" class="block px-4 py-2 text-sm hover:bg-purple-600" role="menuitem">Editar Animes</a>
                </div>
            </div>
        `;
  }
  ...
  init() {
    ...
    // Verificar e atualizar estado de login
    this.checkLoginStatus();
  }

  initializeEvents() {
    // Toggle do menu admin
    ...
    document.addEventListener('click', (e) => {
      if (adminMenu && !adminButton?.contains(e.target) && !adminMenu.contains(e.target)) {
