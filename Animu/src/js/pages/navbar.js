  ...
  getAdminPanel() {
    return `
        <div class="admin-menu-container">
            <button id="admin-menu-button" class="p-2 rounded-lg transition-colors hover:bg-purple-100 dark:hover:bg-purple-900">
            ...
            <div id="admin-menu-items" class="admin-menu hidden">
                ...
                <a href="#" class="admin-menu-item">Categorias</a>
                <a href="./add-anime.html" class="admin-menu-item">Adicionar anime</a>
                <a href="./edit-anime.html" class="admin-menu-item">Editar Animes</a>
            </div>
        </div>
    `;
  }
